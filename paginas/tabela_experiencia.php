	...
	$conteudo_pagina .= '
		<div class="conteudo_pagina" carregar_box="1" carregar_imagem_titulo="'.$imagemTitulo.'">
			<div class="conteudo_box pagina padding">
				...
				<br>
				Você também pode visualizar a '.($id != "profissao" ? '<a href="?p=tabela_experiencia-profissao">tabela de experiência de profissão</a>' : '<a href="?p=tabela_experiencia">tabela de experiência comum</a>').'.<br>
				<br>
