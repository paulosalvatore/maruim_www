		...
		if(count($listaPersonagens) < $config["players"]["maxPersonagens"]){
			$sql_queries = array(
				"players" => array(
					...
					"posx" => $config["players"]["posicoes"][$formulario["vocacao_personagem"]][0],
					"posy" => $config["players"]["posicoes"][$formulario["vocacao_personagem"]][1],
					"posz" => $config["players"]["posicoes"][$formulario["vocacao_personagem"]][2],
