	...
	$formulario_criacao_conta = array(
		array(
			"conta" => array(
				...
				"igual" => "",
				"msg_unico" => "Essa conta jб estб em uso. Por favor digite outra!",
				"msg_igual" => ""
			),
			"email" => array(
				"exibicao" => "E-mail",
				...
				"igual" => "",
				"msg_unico" => "Esse e-mail jб estб em uso. Por favor digite outro!",
				"msg_igual" => ""
			),
			"senha" => array(
				"exibicao" => "Senha",
		...
		array(
			...
			"sexo_personagem" => array(
				...
				"adicional" => "Vocк poderб escolher a vocaзгo do personagem na pбgina seguinte."
			)
		)
	);
	if($chaveAcessoObrigatoria){
		$formulario_criacao_conta[] = array(
			"chave_acesso" => array(
				...
				"unico" => false,
				"igual" => "",
				"msg_unico" => "Chave de acesso invбlida!",
				"msg_igual" => ""
			)
		);
	}
